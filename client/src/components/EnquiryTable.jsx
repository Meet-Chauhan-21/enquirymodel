                    ...
                    <tr>
                      <td colSpan="5" className={`px-6 py-12 text-center ${
                        ...
                        <div className="flex flex-col items-center space-y-3">
                          ...
                          <div>
                            <p className="text-lg font-medium">{searchTerm ? 'No matching enquiries found' : 'No enquiries found'}</p>
                            <p className="text-sm">{searchTerm ? 'Try adjusting your search terms' : 'Get started by submitting your first enquiry'}</p>
                          </div>
                        </div>
                      </td>
                    </tr>
