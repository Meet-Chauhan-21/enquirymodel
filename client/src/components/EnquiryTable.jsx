...
const EnquiryTable = ({ data,getEnquiry,Swal,setFormData}) => {
    ...
    return (
        <div className='bg-white shadow-xl rounded-3xl p-4 md:p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300'>
            <div className='flex items-center justify-between mb-6 flex-wrap gap-4'>
                <div className='flex items-center'>
                    ...
                    <h2 className='text-xl md:text-2xl font-bold text-gray-800'>📊 Enquiries Database</h2>
                </div>
